...
const BrainNode: React.FC<BrainNodeProps> = ({
  ...
  const ringStyle = useMemo(
    () => ({
      ...
      bottom: `-${gapSize}px`,
      borderRadius: '50%',
      border: `2px solid ${isFilled ? 'var(--line-active)' : 'var(--line-base)'}`,
      transition: 'all 0.3s ease',
  ...
  const nodeStyle = useMemo(
    () => ({
      ...
      right: '0',
      bottom: '0',
      backgroundColor: isFilled ? 'var(--line-active)' : 'var(--line-base)',
      borderRadius: '50%',
      transition: 'all 0.3s ease',
      zIndex: 12,
    }),
  ...
  return (
    ...
    >
      ...
      {isActive && (
        ...
        >
          <div style={{ position: 'absolute', inset: 0, backgroundColor: 'var(--hover-bg)' }} />
