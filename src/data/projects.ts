...
export const projects: Project[] = [
  {
    ...
    name: 'Neko Sekai',
    description:
      'An interactive cat app where you feed, play, and level up your virtual pet, unlocking new abilities and rewards.',
  ...
  },
  {
    ...
    description:
      'An AI-powered bot navigating mazes to rescue crew members while evading alien threats.',
  ...
  },
  {
    ...
    name: 'Tch.ai',
    description:
      'An AI music app that recommends songs based on mood analysis from facial expressions and text.',
  ...
  },
  {
    ...
    name: 'UniDB',
    description:
      'A robust database of student profiles and courses with a Java interface for dynamic queries.',
  ...
  },
  {
    ...
    name: 'MiniTorch',
    description:
      'A reimplementation of the PyTorch API featuring autodiff, broadcasting, and CUDA-accelerated tensor operations.',
  ...
  },
  {
    ...
    name: 'Protoclear',
    description:
      'An AI-powered compliance toolkit that analyzes IRB regulations using NLP and provides context-aware recommendations.',
  ...
  },
  {
    ...
    name: 'ReddiGist',
    description:
      'A discussion analyzer that processes Reddit threads to extract key insights using NLP and multi-threaded processing.',
  ...
  },
  {
    ...
    description:
      'A machine learning pipeline that predicts internet usage severity in youth using physical activity data and advanced ML models.',
